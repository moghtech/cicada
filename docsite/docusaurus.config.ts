...
const config: Config = {
  title: "Cicada",
  tagline: "Secure configuration distribution",
  ...
  projectName: "cicada", // Usually your repo name.
  trailingSlash: false,
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/moghtech/cicada/tree/main/docsite",
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://docs.rs/cicada_client/latest/cicada_client",
          label: "Docs.rs",
          position: "right",
        },
        {
          href: "https://github.com/moghtech/cicada",
          label: "GitHub",
          position: "right",
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: "Project",
          items: [
            { label: "GitHub", href: "https://github.com/moghtech/cicada" },
            { label: "Donate", href: "https://opencollective.com/cicada" },
